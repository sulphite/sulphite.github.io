...
const projectdata = {
  donut: {
    ...
    image_url: "https://cdn.discordapp.com/attachments/859729768077066300/1105984580210663524/signal-2023-05-10-230704_002.gif",
    tools: ["Rails", "Heroku", "PostgreSQL", "APIs"],
    animation: {
      init: {opacity: 0},
  ...
  hack: {
    ...
    github: "https://github.com/sulphite/givein",
    url: "",
